import initializeEnterExitUpdatePattern from './initializeEnterExitUpdatePattern';


// This method retrieves passed node's children IDs (including node)      
function getNodeChildrenIds({
    data,
    children,
    _children
}, nodeIdsStore) {
...
function setZoomFactor(zoomLevel) {
    const attrs = this.getChartState();
    const calc = attrs.calc;
...
function setExpansionFlagToChildren({
    data,
    children,
    _children
}, flag) {
...
function setExpanded(id, expandedFlag) {
    const attrs = this.getChartState();
